...
from services.inventory_service import FinishedGoodsHistoryService, FinishedGoodsService

from .serializers import FinishedGoodsSerializer, FinishedGoodsUpdateSerializer
...
class FinishedGoodByBatchView(APIView):
    def get(self, request, batch_id):
        return Response({"data": FinishedGoodsService.get_by_batch(str(batch_id))})
